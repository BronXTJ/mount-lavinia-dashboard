...
export default function DeveloperModal({ open, onClose }) {
  ...
  const links = [
    { id: 'github', label: 'GitHub', href: DEVELOPER_CREDIT.github, external: true },
          ...
          <div className="dev-world-terminal pointer-events-auto w-full max-w-md overflow-hidden rounded-xl border border-[#00b4d8]/35 shadow-[0_0_40px_rgba(0,180,216,0.15)]">
            ...
            >
              ...
              <a
                ...
                title={`github.com/${DEVELOPER_CREDIT.handle}`}
                className="dev-github-handle mt-2 inline-flex items-center gap-0.5 rounded-md border border-[#00b4d8]/40 bg-[#00b4d8]/10 px-2.5 py-1 font-mono text-[15px] font-bold tracking-wide transition-all hover:-translate-y-0.5 hover:border-[#00b4d8]/70 hover:bg-[#00b4d8]/18 hover:shadow-[0_0_18px_rgba(0,180,216,0.35)]"
              >
                <span className="text-[#64748b]" aria-hidden>
                  &lt;/
                </span>
                <span className="text-[#7dd3fc]">{DEVELOPER_CREDIT.handle}</span>
                <span className="text-[#64748b]" aria-hidden>
                  &gt;
                </span>
              </a>
